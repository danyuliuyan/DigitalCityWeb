...
//        FileOutputStream fos = new FileOutputStream(new File(savePath));
        ...
        Iterator writers=ImageIO.getImageWritersByFormatName(savePath.substring(savePath.lastIndexOf(".")+1));
        ImageWriter imageWriter=(ImageWriter) writers.next();
        ImageOutputStream ios=ImageIO.createImageOutputStream(new File(savePath));
...
//        fos.close();
        ...
        jpegImageWriteParam.setCompressionQuality(quality);
    ...
    public static String resize(int width, int height, String savePath, File targetFile) throws ImageFormatException, IOException {
        ...
        System.out.println("0:"+size[0]+" 1:"+ size[1]);
        return resize(size[0], size[1], savePath, image);
    }

    /**
     *
     * <b>function:</b> 将targetFile按照指定width、height的图片缩小，并保存在savePath目录
     * @author hoojo
     * @createDate 2012-2-6 下午04:57:02
     * @param width 缩小的宽度
     * @param height 缩小的高度
     ...
     * @throws IOException
     */
    public static String resizeBywidthAndHeight(int width, int height, String savePath, File targetFile) throws ImageFormatException, IOException {
        image = ImageIO.read(targetFile);
        return resize(width, height, savePath, image);
    }
...
//        System.out.println(ScaleImageUtils.resizeBywidthAndHeight(140, 140, "d:\\6.png", new File("d:\\5.png")));
//        ScaleImageUtils.resize(100, 100, ImageQuality.high.getQuality(), null, ImageIO.read(new URL("http://www.open-open.com/lib/images/logo.jpg")));
        System.out.println(ScaleImageUtils.resizeByHeight( 40, "d:\\2786001_103450039000_1.thumb.jpg", new File("d:\\2786001_103450039000_2.jpg")));
    }
}
