...
<header id="bjui-header">
    ...
    <nav id="bjui-navbar-collapse">
        <ul class="bjui-navbar-right">
            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">当前用户：${admin.username}<span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                    <%--<li><a href="{:U('Admin/User/modifyPwd')}" data-toggle="dialog" data-id="changepwd_page" data-mask="true" data-width="400" data-height="260">&nbsp;<span class="fa fa-lock"></span> 修改密码</a></li>--%>
                        <li><a href="${pageContext.request.contextPath}/admin/Admin/editUsername?id=${admin.id}" data-toggle="dialog" data-id="edit_username" data-mask="true" data-width="400" data-height="120">&nbsp;<span class="fa fa-user"></span> 修改用户名</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/Admin/editPassword?id=${admin.id}" data-toggle="dialog" data-id="edit_password" data-mask="true" data-width="880" data-height="280">&nbsp;<span class="fa fa-user"></span> 修改密码</a></li>
